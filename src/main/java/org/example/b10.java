...
public class b10 {
    public static void main(String[] args)throws Exception {
        ...
        answer.put("activatedBy", studentCode);
        ...
        HttpRequest putRequest = HttpRequest.newBuilder().uri(URI.create(putUrl))
                .header("Content-Type", "application/json")
                .PUT(HttpRequest.BodyPublishers.ofString(body.toString()))
                .build();
        String response2= client.send(putRequest, HttpResponse.BodyHandlers.ofString()).body();
